...
- (void)updateThumbnails:(UIImage * _Nonnull)input;
@end
...
/// When set to true, thumbnails will be recreated, every time the user re-enters the filter dialog. The resulting thumbnails will include crop, and other operations. The major drawback is the extra needed processing power and time. Defaults to false.
...
/// This will not reset the image after either imageRatio or frame is set. This can be used to prevent double download of an image.
