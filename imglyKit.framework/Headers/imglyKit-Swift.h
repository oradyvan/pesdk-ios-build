...
@property (nonatomic, readonly, copy) void (^ _Nullable sliderConfigurationClosure)(UISlider * _Nonnull);
...
/// This closure will be called whenever the value of the slider changes. The UISlider and the active AdjustTool will be passed as parameters.
@property (nonatomic, readonly, copy) void (^ _Nullable sliderChangedValueClosure)(UISlider * _Nonnull, enum AdjustTool);
...
/// This closure can be used to configure the slider that is visible when selecting an adjust tool.
@property (nonatomic, copy) void (^ _Nullable sliderConfigurationClosure)(UISlider * _Nonnull);

/// This closure can be used to configure the view that contains the slider and that is visible when selecting an adjust tool.
@property (nonatomic, copy) void (^ _Nullable sliderContainerConfigurationClosure)(UIView * _Nonnull);

/// This closure will be called whenever the value of the slider changes. The UISlider and the active AdjustTool will be passed as parameters.
@property (nonatomic, copy) void (^ _Nullable sliderChangedValueClosure)(UISlider * _Nonnull, enum AdjustTool);
...
@property (nonatomic) float photoEffectIntensity;
...
@property (nonatomic, readonly, strong) UISlider * _Nonnull filterIntensitySlider;
...
@property (nonatomic, readonly, copy) void (^ _Nullable filterIntensitySliderConfigurationClosure)(UISlider * _Nonnull);
...
@property (nonatomic, readonly) float initialFilterIntensity;
@end
...
@property (nonatomic, copy) void (^ _Nullable filterIntensitySliderConfigurationClosure)(UISlider * _Nonnull);
...
/// The initial intensity of the filters.
@property (nonatomic) float initialFilterIntensity;
...
/// This closure will be called whenever the value of the slider changes. The UISlider and the selected instance of PhotoEffect will be passed as parameters.
@property (nonatomic, readonly, copy) void (^ _Nullable filterIntensityChangedClosure)(UISlider * _Nonnull, IMGLYPhotoEffect * _Nonnull);
...
/// This closure will be called whenever the value of the slider changes. The UISlider and the selected instance of PhotoEffect will be passed as parameters.
@property (nonatomic, copy) void (^ _Nullable filterIntensityChangedClosure)(UISlider * _Nonnull, IMGLYPhotoEffect * _Nonnull);
...
/// This closure is called whenever the slider changes its value. The instance of UISlider and the active focus type are passed as parameters.
@property (nonatomic, readonly, copy) void (^ _Nullable sliderChangedValueClosure)(UISlider * _Nonnull, IMGLYFocusType);
...
/// This closure is called whenever the slider changes its value. The instance of UISlider and the active focus type are passed as parameters.
@property (nonatomic, copy) void (^ _Nullable sliderChangedValueClosure)(UISlider * _Nonnull, IMGLYFocusType);
