...
typedef SWIFT_ENUM(NSInteger, TextDesignOverlayAction) {
...
/// :nodoc:
- (nonnull instancetype)initWithBrightness:(double)brightness contrast:(double)contrast shadows:(double)shadows highlights:(double)highlights exposure:(double)exposure clarity:(double)clarity saturation:(double)saturation gamma:(double)gamma OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
...
/// :nodoc:
- (nonnull instancetype)initWithNormalizedControlPoint1:(CGPoint)normalizedControlPoint1 normalizedControlPoint2:(CGPoint)normalizedControlPoint2 normalizedBlurRadius:(double)normalizedBlurRadius normalizedFadeWidth:(double)normalizedFadeWidth type:(enum PESDKFocusType)type blurQuality:(enum BlurQuality)blurQuality OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
